...
public partial class ClientBlockDestroySystem : SystemBase
{
    ...
    protected override void OnCreate()
    {
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadOnly<SendClientBlockDestroyRpc>(), ComponentType.ReadOnly<ReceiveRpcCommandRequestComponent>()));
    ...
    protected override void OnUpdate()
    {
        ...
        var posHandle = Entities
            .ForEach((Entity entity, in SendClientBlockDestroyRpc request, in ReceiveRpcCommandRequestComponent requestSource) =>
            {
                ...
                Debug.Log($"Rpc Client Recv block Destroy {request.Pos}");
            ...
            Entities
                ...
                .ForEach((Entity entity, int entityInQueryIndex, in Translation trans) =>
                {
                    for (int i = 0; i < posList.Length; ++i)
                    {
                        ...
                        {
                            Debug.Log($"Rpc find block Destroy {posList[i]}");
